...
dnf -y install php-fpm php-cli php-mysqlnd php-pecl-memcached php-memcached php-common php-zip php-gd php-mbstring php-curl php-xml php-pear php-bcmath php-json tar wget htop screen nano
